...
import '../features/trainer_features/add_program/presentation/views/add_program.dart';
...
import '../features/trainer_features/create_sessions/presentation/views/screens/availability.dart';
import '../features/trainer_features/create_sessions/presentation/views/screens/session_settings.dart';
...
class TrainerRoutes {
  ...
  Route<dynamic> generateRoute(RouteSettings settings, BuildContext context) {
    switch (settings.name) {
      ...
      case SessionSettingsScreen.routeName:
        return MaterialPageRoute(
          builder: (context) => const SessionSettingsScreen(),
        );
      case AvailabilityScreen.routeName:
        return MaterialPageRoute(
